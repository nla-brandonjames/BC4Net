    ...
    public class NewtonSoftJsonDeserializer : IDeserializer
    {
        ...
        public T Deserialize<T>(IRestResponse response)
        {
                ...
                response.StatusCode == System.Net.HttpStatusCode.NoContent)
            {
                ...
                {
                    Console.WriteLine("NewtonSoftJsonDeserializer | {0}", response.ResponseUri, ex);
                    Console.WriteLine("NewtonSoftJsonDeserializer InnerException | {0}",
                        response.ResponseUri, (ex.InnerException != null ? ex.InnerException.Message : ""));
                    Console.WriteLine("Response.Content | {0}", response.Content, ex);
