...
namespace BigCommerce4Net.Api.ResourceClients
{
    public class ClientShippingMethods : ClientBase
    {
        ...
        {
            string resourceEndpoint = $"shipping/zones/{zoneId}/methods";
            return await GetDataAsync<List<ShippingMethod>>(resourceEndpoint);
        }
        public async Task<IClientResponse<HttpOptions>> GetHttpOptionsAsync(int zoneId)
        {
            string resourceEndpoint = $"shipping/zones/{zoneId}/methods";
